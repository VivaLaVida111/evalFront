...
<!--        <el-button type="primary" @click="showTableEntry">表格式录入</el-button>-->
      ...
      <div v-if="currentView === 'OptionalEntry'">
        <InspectionRegistryOptionalSrzx />
      </div>
      <div v-if="currentView === 'ExcelEntry'">
        <InspectionRegistryExcelSrzx />
      </div>
...
<!--      </div>-->
  ...
  import InspectionRegistryExcelSrzx from "@/views/content/components/InspectionRegistryExcelSrzx.vue";
  import InspectionRegistryOptionalSrzx from "@/views/content/components/InspectionRegistryOptionalSrzx.vue";
